...
drug_interpret <- 1 # 1 if want to conduct the meta-analysis based on drug interpretation. 0 if according to drug profile
if (drug_interpret == 1) { # 
...
if (drug_interpret == 1) {
  datAll <- datAll %>%
    mutate(
      ...
      d = ifelse((AuthorY == "Frank, 2006" | AuthorY == "Jocham, 2011" | AuthorY == "Pizzagalli, 2008" | AuthorY == "Murray, 2019" | AuthorY == "Wagner, 2020" | (AuthorY == "Campbell-Meiklejohn, 2011" & neurotransmitter == 'DA') | AuthorY == "Admon, 2017" | AuthorY == "Erfanian Abdoust, 2024"), d * -1, d),
      
      # Invert drug_activity: 'agonist' becomes 'antagonist' and vice versa
      drug_activity = ifelse(
        (AuthorY == "Frank, 2006" | AuthorY == "Jocham, 2011" | AuthorY == "Pizzagalli, 2008" | AuthorY == "Murray, 2019" | AuthorY == "Wagner, 2020" | (AuthorY == "Campbell-Meiklejohn, 2011" & neurotransmitter == 'DA') | AuthorY == "Admon, 2017" | AuthorY == "Erfanian Abdoust, 2024"),
  ...
  "Frank, 2006", "Jocham, 2011", "Pizzagalli, 2008", "Murray, 2019",
...
# overall effects - remove duplicate participant studies: Weber, 2016; Westbrook 2024;
